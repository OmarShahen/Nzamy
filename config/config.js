module.exports = {
  ...
  GENDER: ["MALE", "FEMALE"],
  SOURCES: ["whatsapp", "messenger", "instagram"],
  ...
  LOYALTY_TRANSACTION_REASONS: ["purchase", "referral", "review", "signup", "birthday", "manual_adjustment", "redemption", "expiration"],
  LOYALTY_RULE_ACTION_TYPES: ["purchase", "referral", "review", "signup", "birthday"],
